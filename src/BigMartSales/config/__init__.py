...
from BigMartSales.entity import DataIngestionConfig,TrainingPipelineConfig,DataValidationConfig,DataTransformationConfig,ModelTrainerConfig,ModelEvaluationConfig,ModelPusherConfig
    ...
    def get_model_trainer_config(self) -> ModelTrainerConfig:
        try:
            ...
            model_config_file_path = os.path.join(ROOT_DIR,
                                                    model_trainer_config_info[MODEL_TRAINER_MODEL_CONFIG_DIR_NAME_KEY],
