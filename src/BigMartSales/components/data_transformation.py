...
from BigMartSales.entity import DataTransformationConfig
from BigMartSales.entity import DataIngestionArtifact, DataValidationArtifact, DataTransformationArtifact
...
class DataTransformation:
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        try:
            ...
            logger.info(f'Seperating input features and target feature from test and train')
            ...
            logger.info(f'Starting applying preprocessing object on both files ')
            ...
            logger.info(f'To check operations performed correctly or not will save this dataframe')
            ...
            transformed_train_file_path = Path(os.path.join(transformed_train_dir, train_file_name))
            ...
            preprocessing_obj_file_path = Path(self.data_transformation_config.preprocessed_object_file_path)
            ...
            logger.info(f'Data Transformation artifact : {data_transformation_artificat}')
    ...
    def __del__(self):
        ...
        logger.info(f'{">>"*30} Data Transformation completed {"<<"*30}')